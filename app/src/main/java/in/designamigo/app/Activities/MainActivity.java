...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = (ImageView) findViewById(R.id.PimageView);
        textView = (TextView) findViewById(R.id.Pname);

//        Picasso.with(this).load(UserInformation.image_url).into(imageView);
//        textView.setText(UserInformation.username);
        ...
        if(UserInformation.tag.equalsIgnoreCase("To Buy Designs")){
